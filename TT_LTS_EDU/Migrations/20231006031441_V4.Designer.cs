...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TT_LTS_EDU.Entities.Slides", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TT_LTS_EDU.Entities.UserVoucher", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TT_LTS_EDU.Entities.Voucher", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TT_LTS_EDU.Entities.UserVoucher", b =>
                {
                    ...
                    b.HasOne("TT_LTS_EDU.Entities.Voucher", "Voucher")
                        .WithMany()
            ...
            modelBuilder.Entity("TT_LTS_EDU.Entities.Voucher", b =>
                {
                    b.HasOne("TT_LTS_EDU.Entities.User", null)
                        .WithMany("Voucher")
                        .HasForeignKey("UserID");
                });
